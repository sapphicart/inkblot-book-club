...
export default function Hero() {
    ...
    return (
        <div className="flex flex-col w-full justify-end h-screen py-12">
            <div className="flex flex-col w-full items-start justify-end pb-10">
                <motion.div
                ...
                >
                    <Image
                        ...
                        priority={true}
                        className="-z-10 overflow-y-hidden overflow-x-hidden"
                        placeholder="blur"
                    ></Image>
                </motion.div>
                <motion.div
